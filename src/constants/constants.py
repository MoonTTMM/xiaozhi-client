...
class VideoConfig:
    ...
    DEFAULT_FRAME_SKIP_RATIO = 1
    
    # 分析器配置
    DEFAULT_MOTION_THRESHOLD = 25.0
    DEFAULT_MIN_MOTION_AREA = 500
    DEFAULT_COLOR_THRESHOLD = 0.1
    DEFAULT_BRIGHTNESS_THRESHOLD = 0.3
    DEFAULT_MIN_OBJECT_AREA = 1000
    DEFAULT_MAX_OBJECT_AREA = 50000